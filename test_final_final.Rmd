...
**Thành viên nhóm 9**  
- NGUYỄN VĂN ANH VŨ <22110264>  
- ĐỖ CÔNG TUẤN <22110250>  
- TRẦN KHẢI VĂN <22110258>  
- DƯƠNG THỊ NGỌC TUYỀN <22110254>  
- NGUYỄN CÔNG THÀNH <22110205>  
- TRẦN CHÍ HOÀNG VIỆT <22110260>  
...
Ta sẽ tính tương quan giữa các chỉ số của cầu thủ với nhau 
Ở đây ta sẽ tính shot_power với finishing của các cầu thủ thuộc vị trí tiền đạo
...
Ta thấy age không có tính tương quan cao với value, do đó ta sẽ không dùng cột age trong mô hình hồi quy tuyến tính <br>
Sau đó xây dựng mô hình hồi quy tuyến tính cho value dựa trên các cột overall, wage, release_clause, potential, international_reputation trong model_data2.
